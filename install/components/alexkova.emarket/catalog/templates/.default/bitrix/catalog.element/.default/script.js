...
function setBasketIds(id) {
    $('.offer-buy-form .quantity-button-offer-minus').attr('id','quantity-button-minus-'+id);
    $('.offer-buy-form .quantity-button-offer-plus').attr('id','quantity-button-plus-'+id);
    $('.offer-buy-form input[name="item"]').val(id);
    $('.offer-buy-form .quantity-text').attr('id','quantity-offer-'+id);
    $('.offer-buy-form .one-click-button').data("offer",id);
    $('.offer-buy-form .one-click-button').attr("data-offer",id);
}