...
<?if($arParams['USE_FILTER'] == "Y"):?>    
                <?
                    ...
                    if(isset($arParams['CONVERT_CURRENCY']) && $arParams['CONVERT_CURRENCY'] == "Y") {
                        $arParamsFilter["CONVERT_CURRENCY"] = "Y";
                        $arParamsFilter["CURRENCY_ID"] = $arParams["CURRENCY_ID"];
                    }
                ?>
...
<?endif;?>
    ...
    <?if ($arParams["SHOW_LEFT_CATALOG_MENU"] == "Y") {?>
