...
$arTemplateParameters["SEF_MODE"] = array(
	...
	"section" => array(
		...
		"DEFAULT" => "#BRAND_CODE#/#SECTION_ID#/",
		"VARIABLES" => array("SECTION_ID"=>"SID"),
	),
	"element" => array(
		"NAME" => GetMessage("DETAIL_PAGE"),
		"DEFAULT" => "/catalog/#SECTION_ID#/#ELEMENT_ID#/",
	...
	"brand" => array(
		...
		"DEFAULT" => "#BRAND_CODE#/",
		"VARIABLES" => array("BRAND_CODE"=>"BRAND_CODE"),
	),
);
...
$arTemplateParameters['BRAND_PAGE_MASK'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('CP_BRAND_PAGE_MASK'),
	'TYPE' => 'STRING',
	'DEFAULT' => GetMessage('CP_BRAND_PAGE_MASK_TITLE'),
);
