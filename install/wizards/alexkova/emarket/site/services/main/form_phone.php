...
//форма
$arFormCreate = array(
	"NAME"              => GetMessage("EMARKET_PHONE_NAME"),
	"SID"               => "EMARKET_PHONE",
	"C_SORT"            => 100,
	"BUTTON"            => GetMessage("EMARKET_PHONE_BUTTON_TEXT"),
	"DESCRIPTION"       => GetMessage("EMARKET_PHONE_DESCRIPTION"),
	"DESCRIPTION_TYPE"  => "text",
	"STAT_EVENT1"       => "form",
	"STAT_EVENT2"       => "phone_form",
	"arSITE"            => array(WIZARD_SITE_ID),
	"arMENU"            => array("ru" => GetMessage("EMARKET_PHONE_NAME"), "en" => "Express Order"),
	"USE_CAPTCHA"		=> "N",
...
//форма
$rsForm = CForm::GetBySID("EMARKET_PHONE");
...
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."ajax/", Array("PHONE_FORM_ID" => $formID));
?>