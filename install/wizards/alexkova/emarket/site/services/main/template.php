...
if ($arSite = $obSite->Fetch())
{
	...
	if (!$found)
		...
		//$arTemplates[]= Array("CONDITION" => '$_GET[\'kc_ajax_req\']==\'yes\'', "SORT" => 200, "TEMPLATE" => WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID);
...
COption::SetOptionString("main", "wizard_template_id", "topshop", false, WIZARD_SITE_ID);
?>
