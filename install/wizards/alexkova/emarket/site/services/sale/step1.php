...
COption::SetOptionString("alexkova.emarket", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID);
...
//SocNets
if ($wizard->GetVar("templateID") == "topshop")
{
	$shopFacebook = $wizard->GetVar("shopFacebook");
	COption::SetOptionString("alexkova.emarket", "shopFacebook", $shopFacebook, false, WIZARD_SITE_ID);
	$shopTwitter = $wizard->GetVar("shopTwitter");
	COption::SetOptionString("alexkova.emarket", "shopTwitter", $shopTwitter, false, WIZARD_SITE_ID);
	$shopGooglePlus= $wizard->GetVar("shopGooglePlus");
	COption::SetOptionString("alexkova.emarket", "shopGooglePlus", $shopGooglePlus, false, WIZARD_SITE_ID);
	if (LANGUAGE_ID == "ru")
	{
		$shopVk = $wizard->GetVar("shopVk");
		COption::SetOptionString("alexkova.emarket", "shopVk", $shopVk, false, WIZARD_SITE_ID);
	}
}
if($bRus || COption::GetOptionString("alexkova.emarket", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	if ($shopLocalization == "ru")
	{
		...
		COption::SetOptionString("alexkova.emarket", "shopLocation", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName");
		COption::SetOptionString("alexkova.emarket", "shopOfName", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr");
		COption::SetOptionString("alexkova.emarket", "shopAdr", $shopAdr, false, WIZARD_SITE_ID);

		$shopINN = $wizard->GetVar("shopINN");
		COption::SetOptionString("alexkova.emarket", "shopINN", $shopINN, false, WIZARD_SITE_ID);
		$shopKPP = $wizard->GetVar("shopKPP");
		COption::SetOptionString("alexkova.emarket", "shopKPP", $shopKPP, false, WIZARD_SITE_ID);
		$shopNS = $wizard->GetVar("shopNS");
		COption::SetOptionString("alexkova.emarket", "shopNS", $shopNS, false, WIZARD_SITE_ID);
		$shopBANK = $wizard->GetVar("shopBANK");
		COption::SetOptionString("alexkova.emarket", "shopBANK", $shopBANK, false, WIZARD_SITE_ID);
		$shopBANKREKV = $wizard->GetVar("shopBANKREKV");
		COption::SetOptionString("alexkova.emarket", "shopBANKREKV", $shopBANKREKV, false, WIZARD_SITE_ID);
		$shopKS = $wizard->GetVar("shopKS");
		COption::SetOptionString("alexkova.emarket", "shopKS", $shopKS, false, WIZARD_SITE_ID);
		$siteStamp = $wizard->GetVar("siteStamp");
		if ($siteStamp == "" )
			$siteStamp = COption::GetOptionString("alexkova.emarket", "siteStamp", "", WIZARD_SITE_ID);
	}
	elseif ($shopLocalization == "ua")
	{
		...
		COption::SetOptionString("alexkova.emarket", "shopLocation_ua", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName_ua");
		COption::SetOptionString("alexkova.emarket", "shopOfName_ua", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr_ua");
		COption::SetOptionString("alexkova.emarket", "shopAdr_ua", $shopAdr, false, WIZARD_SITE_ID);

		$shopEGRPU_ua = $wizard->GetVar("shopEGRPU_ua");
		COption::SetOptionString("alexkova.emarket", "shopEGRPU_ua", $shopEGRPU_ua, false, WIZARD_SITE_ID);
		$shopINN_ua = $wizard->GetVar("shopINN_ua");
		COption::SetOptionString("alexkova.emarket", "shopINN_ua", $shopINN_ua, false, WIZARD_SITE_ID);
		$shopNDS_ua = $wizard->GetVar("shopNDS_ua");
		COption::SetOptionString("alexkova.emarket", "shopNDS_ua", $shopNDS_ua, false, WIZARD_SITE_ID);
		$shopNS_ua = $wizard->GetVar("shopNS_ua");
		COption::SetOptionString("alexkova.emarket", "shopNS_ua", $shopNS_ua, false, WIZARD_SITE_ID);
		$shopBank_ua = $wizard->GetVar("shopBank_ua");
		COption::SetOptionString("alexkova.emarket", "shopBank_ua", $shopBank_ua, false, WIZARD_SITE_ID);
		$shopMFO_ua = $wizard->GetVar("shopMFO_ua");
		COption::SetOptionString("alexkova.emarket", "shopMFO_ua", $shopMFO_ua, false, WIZARD_SITE_ID);
		$shopPlace_ua = $wizard->GetVar("shopPlace_ua");
		COption::SetOptionString("alexkova.emarket", "shopPlace_ua", $shopPlace_ua, false, WIZARD_SITE_ID);
		$shopFIO_ua = $wizard->GetVar("shopFIO_ua");
		COption::SetOptionString("alexkova.emarket", "shopFIO_ua", $shopFIO_ua, false, WIZARD_SITE_ID);
		$shopTax_ua = $wizard->GetVar("shopTax_ua");
		COption::SetOptionString("alexkova.emarket", "shopTax_ua", $shopTax_ua, false, WIZARD_SITE_ID);
	}

	$siteTelephone = $wizard->GetVar("siteTelephone");
	COption::SetOptionString("alexkova.emarket", "siteTelephone", $siteTelephone, false, WIZARD_SITE_ID);
	$shopEmail = $wizard->GetVar("shopEmail");
	COption::SetOptionString("alexkova.emarket", "shopEmail", $shopEmail, false, WIZARD_SITE_ID);
	$siteName = $wizard->GetVar("siteName");
	COption::SetOptionString("alexkova.emarket", "siteName", $siteName, false, WIZARD_SITE_ID);
	...
	if(strlen($siteStamp)>0)
	{
		if(IntVal($siteStamp) > 0)
		{
			...
			if($zr = $ff->Fetch())
			{
				...
				COption::SetOptionString("alexkova.emarket", "siteStamp", $siteStamp, false, WIZARD_SITE_ID);
			}
		}
	}
	else
	...
	COption::SetOptionString("alexkova.emarket", "personTypeFiz", $personTypeFiz, false, WIZARD_SITE_ID);
	$personTypeUr = ($personType["ur"] == "Y") ? "Y" : "N";
	COption::SetOptionString("alexkova.emarket", "personTypeUr", $personTypeUr, false, WIZARD_SITE_ID);
	...
	if ($shopLocalization == "ua")
	{
		...
		COption::SetOptionString("alexkova.emarket", "personTypeFizUa", $personTypeFizUa, false, WIZARD_SITE_ID);
