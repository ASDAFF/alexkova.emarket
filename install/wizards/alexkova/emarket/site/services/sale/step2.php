...
if(COption::GetOptionString("alexkova.emarket", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
	$locationGroupID = 0;
...
COption::SetOptionString("alexkova.emarket", "wizard_installed", "Y", false, WIZARD_SITE_ID);
?>