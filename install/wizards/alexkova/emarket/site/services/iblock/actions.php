...
$iblockCode = "kc_emarket_actions_".WIZARD_SITE_ID;
$iblockCodeDef = "kc_emarket_actions";
$iblockCodeS = "emarket_actions";
$iblockType = "content";
...
if ($IBLOCK_CATALOG_ID == false){
	...
	$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/lang/".LANGUAGE_ID."/iblock/content/actions.xml";
