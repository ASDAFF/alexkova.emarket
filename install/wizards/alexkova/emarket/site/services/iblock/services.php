...
$iblockCode = "kc_emarket_services_".WIZARD_SITE_ID;
$iblockCodeDef = "kc_emarket_services";
$iblockCodeS = "emarket_services";
$iblockType = "content";
...
if ($IBLOCK_CATALOG_ID == false){
	...
	$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/lang/".LANGUAGE_ID."/iblock/content/service.xml";
