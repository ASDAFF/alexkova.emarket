...
$iblockCode = "kc_emarket_articles_".WIZARD_SITE_ID;
$iblockCodeDef = "kc_emarket_articles";
$iblockCodeS = "emarket_articles";
$iblockType = "content";
...
if ($IBLOCK_CATALOG_ID == false){
	...
	$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/lang/".LANGUAGE_ID."/iblock/content/articles.xml";
