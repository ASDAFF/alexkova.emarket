...
$iblockCode = "kc_emarket_slider_".WIZARD_SITE_ID;
$iblockCodeDef = "kc_emarket_slider";
$iblockCodeS = "emarket_slider";
$iblockType = "content";
...
if ($IBLOCK_CATALOG_ID == false){
	...
	$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/lang/".LANGUAGE_ID."/iblock/content/slider.xml";
