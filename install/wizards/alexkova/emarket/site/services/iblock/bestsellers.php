...
$iblockCode = "kc_emarket_bestsellers_".WIZARD_SITE_ID;
$iblockCodeDef = "kc_emarket_bestsellers";
$iblockCodeS = "emarket_bestsellers";
$iblockType = "content";
...
if ($IBLOCK_CATALOG_ID == false){
	...
	$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/lang/".LANGUAGE_ID."/iblock/content/bestsellers.xml";
