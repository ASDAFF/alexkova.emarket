...
$reviewsForumID = 0;
$dbRes = CForumNew::GetListEx(array(), array("SITE_ID" => WIZARD_SITE_ID, "XML_ID" => "EMARKET_REVIEWS"));
if ($arRes = $dbRes->Fetch())
	$reviewsForumID = $arRes["ID"];

WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH, Array("EMARKET_FORUM_ID" => $reviewsForumID));
