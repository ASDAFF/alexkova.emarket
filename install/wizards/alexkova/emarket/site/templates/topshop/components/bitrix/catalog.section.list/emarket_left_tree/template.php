...
<div class="left-menu sm-hide xs-hide">
	<div class="left-catalog-title"><?=GetMessage('EMARKET_CATALOG_TITLE')?></div>
	<?
	$TOP_DEPTH = $arResult["SECTION"]["DEPTH_LEVEL"];
	$CURRENT_DEPTH = $TOP_DEPTH;

	$firstClass='vertical-multilevel-menu';
	$firstElement = true;
	...
	foreach($arResult["SECTIONS"] as $arSection)
	{
		...
		{
			echo "\n",str_repeat("\t", $arSection["DEPTH_LEVEL"]-$TOP_DEPTH),'<ul id="'.$firstClass.'">';
		}
