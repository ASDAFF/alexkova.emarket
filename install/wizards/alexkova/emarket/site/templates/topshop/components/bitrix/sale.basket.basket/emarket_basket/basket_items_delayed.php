				...
				<tr id="<?=$arItem["ID"]?>">
					...
					?>
						<td class="control">
							...
							?>
							<a class="icon-button-cart no-shadow" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["add"])?>"><?=GetMessage("SALE_ADD_TO_BASKET")?></a>
