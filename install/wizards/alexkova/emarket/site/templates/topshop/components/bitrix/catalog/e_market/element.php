...
<?
$typeAlso = '';
$typeAlsoTemplate = '.default';

$typeAlso = '_vertical';
$typeAlsoTemplate = 'vertical';
?>

<?$this->SetViewTarget('emarket_also'.$typeAlso);?>
...
if (0 < $ElementID)
{
	...
	{
		?><?$APPLICATION->IncludeComponent("bitrix:sale.recommended.products", $typeAlsoTemplate , array(
			"ID" => $ElementID,
			"TEMPLATE_THEME" => (isset($arParams['TEMPLATE_THEME']) ? $arParams['TEMPLATE_THEME'] : ''),
...
<?$APPLICATION->ShowViewContent('emarket_also');?>

<div class="span_5_of_5 sm-hide xs-hide">
	<?$APPLICATION->IncludeComponent("bitrix:catalog.set.constructor", "emarket_set_constructor", Array(
	"IBLOCK_TYPE_ID" => $arParams["IBLOCK_TYPE"],	// Тип инфоблока
		"IBLOCK_ID" => $arParams["IBLOCK_ID"],	// Инфоблок
		"ELEMENT_ID" => $ElementID,	// ID элемента
	...
	array(
		...
		"INCLUDE_TITLE" => "Изменить дополнительную информацию"
	),
	false
);?>
		</div>
...
<div class="span_1_of_5 md-hide xs-hide sm-hide">
	...
	<?$APPLICATION->ShowViewContent('emarket_also_vertical');?>
</div>
<div class="clear"></div>
</div>
</div>
