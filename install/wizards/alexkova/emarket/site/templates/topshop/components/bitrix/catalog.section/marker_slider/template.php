...
if (!empty($arResult['ITEMS']))
{
	...
	$idc = htmlspecialchars($_REQUEST["MARK"]);
...
<div class="sale-cart-price-line">
	...
	<input type="button" class="slide-button-prev sm-hide xs-hide" id="c<?=$idc?>_prev" data-fix="c<?=$idc?>" value=" ">
	<input type="button" class="slide-button-next sm-hide xs-hide" id="c<?=$idc?>_next" data-fix="c<?=$idc?>" value=" ">
	<div class="clear"></div>
