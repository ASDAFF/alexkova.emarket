...
$MESS["CP_BC_TPL_COMPARE_SCROLL_UP"] = "Прокрутка к списку Отложенные товары при повторном нажатии на кнопки сравнения в списках товаров";

$MESS["BRAND_ID_DESC"] = "Переменная в которой приходит код бренда";
$MESS["CP_BRAND_PAGE_MASK"] = "Маска для заголовка";
$MESS["CP_BRAND_PAGE_MASK_TITLE"] = "Товары от #BRAND_NAME#";
?>