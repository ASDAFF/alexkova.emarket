		...
		<div id="cart_<?=$arItem["ID"]?>">
			...
			<div class="sale-cart-operation">
				<div class="emarket-sale-buttons">
					...
					<?}else{?>
                                                <a href="<?=$arItem["DETAIL_PAGE_URL"]?><?if (count($arItem["OFFERS"])>0 && $arItem["CAN_BUY"]){?>#detail<?}?>" data-scroll="emarket-offers" class="color-button color-button-blue small scroll-navigate"><?=GetMessage('CATALOG_OFFERS_NEW')?></a>
					<?}?>
