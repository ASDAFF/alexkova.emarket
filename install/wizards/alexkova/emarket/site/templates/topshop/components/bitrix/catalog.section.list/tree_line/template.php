...
<div id="horizontal-multilevel-menu" data-lg="<?=$arParams["RESOLUTION_LG"];?>" data-md="<?=$arParams["RESOLUTION_MD"];?>" data-sm="<?=$arParams["RESOLUTION_SM"];?>" data-xs="<?=$arParams["RESOLUTION_XS"];?>" class="horizontal-multilevel-menu-line">
	<?
