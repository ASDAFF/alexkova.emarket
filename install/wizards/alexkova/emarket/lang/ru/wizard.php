...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Современный интернет-магазин TopShop";
$MESS["WIZ_STEP_SITE_SET"] = "Информация о сайте";
$MESS["WIZ_COMPANY_TELEPHONE"] = "Телефон для обратной связи";
$MESS["WIZ_COMPANY_TELEPHONE_DEF"] = "8 (351) 777-19-19";
...
$MESS["SHOW_NOT_ACCESS_ADV"] =
	"Для установки решения требуется наличие специализированных модулей рекламы.
	<br /><br />Для редакции <b>Бизнес</b> или <b>Бизнес веб-кластер</b> решение использует модуль <b>Реклама</b>, входящий в состав редакций
	<br />Если вы испольуете одну из данных редакций - проверьте, установлен ли данный модуль
	<br /><br />Для редакции <b>Малый бизнес</b> требуется установить модуль <b>Баннеры и реклама Pro</b>,
	<br /> данный модуль поставляется для данного решения <b>БЕСПЛАТНО</b>.<br /><br />
	Если вы не получили купон на данный модуль, обратитесь в службу техподдержки решения <a href='http://support.kuznica74.ru'>http://support.kuznica74.ru</a><br />
	При обращении не забудьте указать номер вашего купона решения \"Современный интернет-магазин Топ Шоп\"";
...
$MESS["wiz_site_desc"] = "Широкий ассортименто товаров по приятным ценам.";
$MESS["wiz_keywords"] = "Электроника, бытовая техника, товары для дома, отдых и развлечения";
$MESS["wiz_meta_data"] = "Метаданные:";
$MESS["wiz_meta_description"] = "Описание сайта:";
$MESS["wiz_meta_keywords"] = "Ключевые слова:";
