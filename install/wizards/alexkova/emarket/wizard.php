...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "alexkova.emarket";
...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		{
			$arTemplates = array("topshop", "topshop_linear");
	...
	function ShowStep()
	{
		...
		//file_put_contents($_SERVER['DOCUMENT_ROOT']."/log.txt", var_export($arTemplates, true),FILE_APPEND);

		$arTemplates["topshop"]["PREVIEW"] = $wizard->GetPath()."/images/".LANGUAGE_ID."/step1_select_templates/preview_style_corner.jpg";
		$arTemplates["topshop"]["SCREENSHOT"] = $wizard->GetPath()."/images/".LANGUAGE_ID."/step1_select_templates/screen_style_corner.jpg";

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "topshop", $wizard->GetVar("siteID"));
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		if(COption::GetOptionString("alexkova.emarket", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
		...
		{
			$arSocNetsValues["facebook"] = COption::GetOptionString("alexkova.emarket", "shopFacebook", GetMessage("WIZ_SHOP_FACEBOOK_DEF"), $siteID);
			$arSocNetsValues["twitter"] = COption::GetOptionString("alexkova.emarket", "shopTwitter", GetMessage("WIZ_SHOP_TWITTER_DEF"), $siteID);
			$arSocNetsValues["vk"] = COption::GetOptionString("alexkova.emarket", "shopVk", GetMessage("WIZ_SHOP_VK_DEF"), $siteID);
			$arSocNetsValues["google"] = COption::GetOptionString("alexkova.emarket", "shopGooglePlus", GetMessage("WIZ_SHOP_GOOGLE_PLUS_DEF"), $siteID);
		}
		else
		{
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopEmail" => COption::GetOptionString("alexkova.emarket", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
